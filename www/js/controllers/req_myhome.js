angular.module('req_myhome.controllers', [])

.controller('reqMyHomeCtrl', function(BACKEND_API, HEADERS, $rootScope, $state, $filter, $http, $ionicScrollDelegate, $ionicSideMenuDelegate, $scope,
